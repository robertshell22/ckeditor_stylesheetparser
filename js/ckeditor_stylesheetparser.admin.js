...
(function ($, Drupal, drupalSettings, _) {
  Drupal.behaviors.ckeditorStylesheetParserSettings = {
    attach: function attach(context) {
      ...
      var that = this;
      $context.find('[name="editor[settings][plugins][stylessheetparser][styles]"]').on('blur.ckeditorStylesheetParserSettings', function () {
  ...
  Drupal.behaviors.ckeditorStylesComboSettingsSummary = {
    attach: function attach() {
      $('[data-ckeditor-plugin-id="stylesheetparser"]').drupalSetSummary(function (context) {
        var styles = $.trim($('[data-drupal-selector="edit-editor-settings-plugins-stylesheetparser-styles"]').val());
        if (styles.length === 0) {
